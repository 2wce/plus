...
class User extends Model implements AuthenticatableContract
{
    ...
    {
        return $this->hasMany('Chatty\Models\Product');
    }
    ...
    {
        return $this->hasMany('Chatty\Models\Service', 'user_id');
    }

    public function collections()
    {
        return $this->hasMany('Chatty\Models\Collection', 'user_id');
    }
 ...
 /**
    ...
    public function myEndorsed(){
        return $this->belongsToMany('Chatty\Models\User', 'tbl_endorsements', 'user_id', 'endorser_id');
    }

    public function endorsedBy(){
        return $this->belongsToMany('Chatty\Models\User', 'tbl_endorsements', 'endorser_id', 'user_id');
    }
    ...
    public function friendsOfMine()
    {
        ...
        return $this->belongsToMany('Chatty\Models\User', 'tbl_connections', 'user_id', 'connection_id');
    }

    public function friendOf()
    {
        return $this->belongsToMany('Chatty\Models\User', 'tbl_connections', 'connection_id', 'user_id');
    }
